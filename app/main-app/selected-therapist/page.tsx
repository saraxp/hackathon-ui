  ...
  if (!selectedTherapist) {
    return (
        <div className="flex items-center justify-center min-h-[50vh]">
            <p className="text-xl text-[#6B2A7D]">Therapist not found.</p>
        </div>
    );
  }
      ...
      <section className='flex justify-center w-full'>
        <div className='container p-4 md:p-6'>
          <div className="mb-6 text-center md:text-left">
            <h1 className="text-3xl md:text-4xl font-medium tracking-tight text-[#403635]">
            ...
            <header className="flex-shrink-0 bg-[#FAF6F3] backdrop-blur-sm z-10">
                <div className="navbar bg-transparent max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="navbar-center">
                        <h1 className="text-3xl md:text-5xl text-[#403635] font-bold">Heart Line</h1>
                    </div>
